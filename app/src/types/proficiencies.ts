...
export enum TOOL_PROFICIENCY {
  ...
  MUSICAL_INSTRUMENT_BAGPIPES = "MUSICAL_INSTRUMENT_BAGPIPES",
  MUSICAL_INSTRUMENT_DRUM = "MUSICAL_INSTRUMENT_DRUM",
  MUSICAL_INSTRUMENT_DULCIMER = "MUSICAL_INSTRUMENT_DULCIMER",
  MUSICAL_INSTRUMENT_FLUTE = "MUSICAL_INSTRUMENT_FLUTE",
  MUSICAL_INSTRUMENT_HORN = "MUSICAL_INSTRUMENT_HORN",
  MUSICAL_INSTRUMENT_LUTE = "MUSICAL_INSTRUMENT_LUTE",
  MUSICAL_INSTRUMENT_LYRE = "MUSICAL_INSTRUMENT_LYRE",
  MUSICAL_INSTRUMENT_PAN_FLUTE = "MUSICAL_INSTRUMENT_PAN_FLUTE",
  MUSICAL_INSTRUMENT_SHAWM = "MUSICAL_INSTRUMENT_SHAWM",
  MUSICAL_INSTRUMENT_VIOL = "MUSICAL_INSTRUMENT_VIOL",
  GAMING_SET_DICE = "GAMING_SET_DICE",
  GAMING_SET_DRAGONCHESS = "GAMING_SET_DRAGONCHESS",
  GAMING_SET_PLAYING_CARDS = "GAMING_SET_PLAYING_CARDS",
  GAMING_SET_THREE_DRAGON_ANTE = "GAMING_SET_THREE_DRAGON_ANTE"
}
