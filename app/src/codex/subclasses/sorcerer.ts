    ...
    features: [
      createSubclassFeatureRow(SUBCLASS_FEATURE_LEVELS.LEVEL_3, CLASS_FEATURE.WILD_MAGIC_SURGE, {
        description: [
          ...
          "69-72. You have the <link:Frightened>Frightened</link> condition until the end of your next turn. The GM determines the source of your fear.",
