...
export const rangerSubclassEntries: SubclassEntry[] = [
  ...
  },
  {
    ...
    features: [
      ...
      createSubclassFeatureRow(SUBCLASS_FEATURE_LEVELS.LEVEL_3, CLASS_FEATURE.FEY_WANDERER_SPELLS, {
        description: [
      ...
      createSubclassFeatureRow(SUBCLASS_FEATURE_LEVELS.LEVEL_11, CLASS_FEATURE.FEY_REINFORCEMENTS, {
        description: [
      ...
      createSubclassFeatureRow(SUBCLASS_FEATURE_LEVELS.LEVEL_15, CLASS_FEATURE.MISTY_WANDERER, {
        description: [
    ...
    features: [
      createSubclassFeatureRow(SUBCLASS_FEATURE_LEVELS.LEVEL_3, CLASS_FEATURE.DREAD_AMBUSHER, {
        description: [
          ...
          "<strong>Ambusher's Leap.</strong> At the start of your first turn of each combat, your <link:Speed>Speed</link> increases by 10 feet until the end of that turn. <link:not-tracked>Not Tracked</link>",
      ...
      createSubclassFeatureRow(SUBCLASS_FEATURE_LEVELS.LEVEL_11, CLASS_FEATURE.STALKERS_FLURRY, {
        description: [
  ...
  },
  {
    ...
    features: [
      ...
      createSubclassFeatureRow(SUBCLASS_FEATURE_LEVELS.LEVEL_7, CLASS_FEATURE.DEFENSIVE_TACTICS, {
        description: [
          "You gain one of the following feature options of your choice. Whenever you finish a <link:short-rest>Short Rest</link> or <link:long-rest>Long Rest</link>, you can replace the chosen option with the other one.",
