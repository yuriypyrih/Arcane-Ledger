...
export const featherFall: SpellEntry = {
  ...
  category: ENTRY_CATEGORIES.SPELLS,
  magicSchool: MAGIC_SCHOOL.TRANSMUTATION,
  castingTime: [ACTION_TYPE.REACTION, "which you take when you or a creature within 60 feet of you falls"],
  range: "60 feet",
...
export const hellishRebuke: SpellEntry = {
  ...
  category: ENTRY_CATEGORIES.SPELLS,
  magicSchool: MAGIC_SCHOOL.EVOCATION,
  castingTime: [ACTION_TYPE.REACTION, "which you take when you are damaged by a creature within 60 feet of you that you can see"],
  range: "60 feet",
  components: [SPELL_COMPONENT.V, SPELL_COMPONENT.S],
  duration: "Instantaneous",
  description: [
...
export const shield: SpellEntry = {
  ...
  category: ENTRY_CATEGORIES.SPELLS,
  magicSchool: MAGIC_SCHOOL.ABJURATION,
  castingTime: [ACTION_TYPE.REACTION, "which you take when you are hit by an attack or targeted by the magic missile spell"],
  range: "Self",
  components: [SPELL_COMPONENT.V, SPELL_COMPONENT.S],
  duration: "1 round",
  description: [
