...
export const arcaneSword: SpellEntry = {
  ...
  legacyIds: ["spell-mordenkainens-sword"],
  legacyNames: ["Mordenkainen's Sword"],
...
export const magnificentMansion: SpellEntry = {
  ...
  legacyIds: ["spell-mordenkainens-magnificent-mansion"],
  legacyNames: ["Mordenkainen's Magnificent Mansion"],
  trackingState: TRACKER.NOT_TRACKED,
  magicSchool: MAGIC_SCHOOL.CONJURATION,
