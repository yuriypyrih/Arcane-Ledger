...
export const animateObjects: SpellEntry = {
  ...
  source: {
    ...
    ruleset: "5e-2024",
    open5eKey: "srd-2024_animate-objects",
...
export const antilifeShell: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_antilife-shell",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
...
export const arcaneHand: SpellEntry = {
  ...
  materialSpecified: "an eggshell and a glove",
  duration: [DURATION.CONCENTRATION, "up to 1 minute"],
  description: [
...
export const awaken: SpellEntry = {
  ...
  range: "Touch",
  components: [SPELL_COMPONENT.V, SPELL_COMPONENT.S, SPELL_COMPONENT.M],
  materialSpecified: "an agate worth 1,000+ GP, which the spell consumes",
...
export const communeWithNature: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_commune-with-nature",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
...
export const coneOfCold: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_cone-of-cold",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
  ...
  range: "Self",
  components: [SPELL_COMPONENT.V, SPELL_COMPONENT.S, SPELL_COMPONENT.M],
  materialSpecified: "a small crystal or glass cone",
  duration: ["Instantaneous"],
  description: [
...
export const conjureElemental: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_conjure-elemental",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
...
export const contactOtherPlane: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_contact-other-plane",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
...
export const creation: SpellEntry = {
  ...
  range: "30 feet",
  components: [SPELL_COMPONENT.V, SPELL_COMPONENT.S, SPELL_COMPONENT.M],
  materialSpecified: "a paintbrush",
  duration: ["Special"],
  description: [
...
export const dispelEvilAndGood: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_dispel-evil-and-good",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
  ...
  range: "Self",
  components: [SPELL_COMPONENT.V, SPELL_COMPONENT.S, SPELL_COMPONENT.M],
  materialSpecified: "powdered silver and iron",
  duration: [DURATION.CONCENTRATION, "up to 1 minute"],
  description: [
...
export const dominatePerson: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_dominate-person",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
...
export const dream: SpellEntry = {
  ...
  range: "Special",
  components: [SPELL_COMPONENT.V, SPELL_COMPONENT.S, SPELL_COMPONENT.M],
  materialSpecified: "a handful of sand",
  duration: ["8 hours"],
  description: [
...
export const flameStrike: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_flame-strike",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
  ...
  range: "60 feet",
  components: [SPELL_COMPONENT.V, SPELL_COMPONENT.S, SPELL_COMPONENT.M],
  materialSpecified: "a pinch of sulfur",
  duration: ["Instantaneous"],
  description: [
...
export const greaterRestoration: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_greater-restoration",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
...
export const hallow: SpellEntry = {
  ...
  range: "Touch",
  components: [SPELL_COMPONENT.V, SPELL_COMPONENT.S, SPELL_COMPONENT.M],
  materialSpecified: "incense worth 1,000+ GP, which the spell consumes",
  ...
  description: [
    ...
    "<strong>_Extra Effect._</strong> You bind an extra effect to the area from the list below:",
    {
      ...
      style: "bullet",
      items: [
        "<strong>_Courage._</strong> Creatures of any types you choose can't gain the Frightened condition while in the area.",
        "<strong>_Darkness._</strong> Darkness fills the area. Normal light, as well as magical light created by spells of a level lower than this spell, can't illuminate the area.",
        "<strong>_Daylight._</strong> Bright light fills the area. Magical Darkness created by spells of a level lower than this spell can't extinguish the light.",
        "<strong>_Peaceful Rest._</strong> Dead bodies interred in the area can't be turned into Undead.",
        "<strong>_Extradimensional Interference._</strong> Creatures of any types you choose can't enter or exit the area using teleportation or interplanar travel.",
        "<strong>_Fear._</strong> Creatures of any types you choose have the Frightened condition while in the area.",
        "<strong>_Silence._</strong> No sound can emanate from within the area, and no sound can reach into it.",
        "<strong>_Tongues._</strong> Creatures of any types you choose can communicate with any other creature in the area even if they don't share a common language.",
...
export const holdMonster: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_hold-monster",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
  ...
  range: "90 feet",
  components: [SPELL_COMPONENT.V, SPELL_COMPONENT.S, SPELL_COMPONENT.M],
  materialSpecified: "a straight piece of iron",
  duration: [DURATION.CONCENTRATION, "up to 1 minute"],
  description: [
...
export const insectPlague: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_insect-plague",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
...
export const legendLore: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_legend-lore",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
...
export const massCureWounds: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_mass-cure-wounds",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
...
export const modifyMemory: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_modify-memory",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
...
export const passwall: SpellEntry = {
  ...
  range: "30 feet",
  components: [SPELL_COMPONENT.V, SPELL_COMPONENT.S, SPELL_COMPONENT.M],
  materialSpecified: "a pinch of sesame seeds",
  duration: ["1 hour"],
  description: [
...
export const planarBinding: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_planar-binding",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
  ...
  range: "60 feet",
  components: [SPELL_COMPONENT.V, SPELL_COMPONENT.S, SPELL_COMPONENT.M],
  materialSpecified: "a jewel worth 1,000+ GP, which the spell consumes",
  duration: ["24 hours"],
  description: [
...
export const raiseDead: SpellEntry = {
  ...
  range: "Touch",
  components: [SPELL_COMPONENT.V, SPELL_COMPONENT.S, SPELL_COMPONENT.M],
  materialSpecified: "a diamond worth 500+ GP, which the spell consumes",
  duration: ["Instantaneous"],
  description: [
...
export const reincarnate: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_reincarnate",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
  ...
  range: "Touch",
  components: [SPELL_COMPONENT.V, SPELL_COMPONENT.S, SPELL_COMPONENT.M],
  materialSpecified: "rare oils worth 1,000+ GP, which the spell consumes",
  duration: ["Instantaneous"],
  description: [
...
export const summonDragon: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_summon-dragon",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
  ...
  range: "60 feet",
  components: [SPELL_COMPONENT.V, SPELL_COMPONENT.S, SPELL_COMPONENT.M],
  materialSpecified: "an object with the image of a dragon engraved on it worth 500+ GP",
  duration: [DURATION.CONCENTRATION, "up to 1 hour"],
  description: [
...
export const telekinesis: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_telekinesis",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
...
export const telepathicBond: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_telepathic-bond",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
...
export const teleportationCircle: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_teleportation-circle",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
  ...
  range: "10 feet",
  components: [SPELL_COMPONENT.V, SPELL_COMPONENT.M],
  materialSpecified: "rare inks worth 50+ GP, which the spell consumes",
  duration: ["1 round"],
  description: [
...
export const treeStride: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_tree-stride",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
...
export const wallOfForce: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_wall-of-force",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
  ...
  range: "120 feet",
  components: [SPELL_COMPONENT.V, SPELL_COMPONENT.S, SPELL_COMPONENT.M],
  materialSpecified: "a shard of glass",
  duration: [DURATION.CONCENTRATION, "up to 10 minutes"],
  description: [
...
export const wallOfStone: SpellEntry = {
  ...
  source: {
    ...
    documentName: "5e 2024 Rules",
    ruleset: "5e-2024",
    open5eKey: "srd-2024_wall-of-stone",
    publisherKey: "wizards-of-the-coast",
    permalink: "https://dnd.wizards.com/resources/systems-reference-document"
  },
  trackingState: TRACKER.NOT_TRACKED,
  ...
  range: "120 feet",
  components: [SPELL_COMPONENT.V, SPELL_COMPONENT.S, SPELL_COMPONENT.M],
  materialSpecified: "a cube of granite",
  duration: [DURATION.CONCENTRATION, "up to 10 minutes"],
  description: [
  ...
  description: [
    "You call out to the spirits of nature to rouse them against your enemies. Choose a point you can see within range. The spirits cause trees, rocks, and grasses in a 60-foot cube centered on that point to become animated until the spell ends.",
    {
      ...
      items: [
        ...
        "<strong>Trees.</strong> At the start of each of your turns, each of your enemies within 10 feet of any tree in the cube must succeed on a Dexterity saving throw or take <strong>4d6</strong> Slashing damage from whipping branches.",
