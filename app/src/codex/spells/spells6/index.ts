...
export const freezingSphere: SpellEntry = {
  ...
  legacyIds: ["spell-otilukes-freezing-sphere"],
  legacyNames: ["Otiluke's Freezing Sphere"],
  trackingState: TRACKER.NOT_TRACKED,
  magicSchool: MAGIC_SCHOOL.EVOCATION,
  castingTime: [ACTION_TYPE.ACTION],
  range: "300 feet",
...
export const instantSummons: SpellEntry = {
  ...
  legacyIds: ["spell-drawmijs-instant-summons"],
  legacyNames: ["Drawmij's Instant Summons"],
  trackingState: TRACKER.NOT_TRACKED,
  magicSchool: MAGIC_SCHOOL.CONJURATION,
  castingTime: [ACTION_TYPE.MINUTE],
  range: "Touch",
...
export const irresistibleDance: SpellEntry = {
  ...
  legacyIds: ["spell-ottos-irresistible-dance"],
  legacyNames: ["Otto's Irresistible Dance"],
  trackingState: TRACKER.NOT_TRACKED,
