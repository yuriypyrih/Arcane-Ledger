...
function createInitialState(
  ...
  return {
    ...
    selectedFluidFormsMonster: null,
    selectedGenieMagicSpell: null,
    isFluidFormsMonsterModalOpen: false,
...
export function useActionsWidgetUiState(
  ...
  const setters = useMemo(
    () => ({
      ...
      setSelectedFluidFormsMonster: createFieldSetter(dispatch, "selectedFluidFormsMonster"),
      setSelectedGenieMagicSpell: createFieldSetter(dispatch, "selectedGenieMagicSpell"),
      setIsFluidFormsMonsterModalOpen: createFieldSetter(dispatch, "isFluidFormsMonsterModalOpen"),
      ...
      setIsVampiricBiteSelected: createFieldSetter(dispatch, "isVampiricBiteSelected"),
