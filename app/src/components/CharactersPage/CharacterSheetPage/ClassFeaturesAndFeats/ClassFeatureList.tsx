...
{renderClassFeatureContent({
                    ...
                    getAvailableRogueThievesCantLanguages, getAvailableSorcererMetamagicOptions, getAvailableWarlockMysticArcanumSpells, getAvailableWeaponMasteryOptions, getAvailableWizardScholarSkills, getAvailableWizardSignatureSpells, getAvailableWizardSpellMasterySpells, getBarbarianPrimalKnowledgeOptions,
                    getBarbarianPrimalKnowledgeSelection, getBarbarianWildHeartAspectChoiceForCharacter, getBardExpertiseSelections, getBardLoreBonusProficiencySelections, getBardMagicalDiscoveriesSpellSelections, getBardPrimalLoreCantripSelection, getBardPrimalLoreSkillOptionsForCharacter, getBardPrimalLoreSkillSelection,
                    getClericDivineOrderChoiceForCharacter, getDamageTypeChoiceContent, getDruidCircleOfTheLandChoiceForCharacter, getDruidPrimalOrderChoiceForCharacter, getFighterBanneretKnightlyEnvoyLanguageSelection, getFighterBanneretKnightlyEnvoySkillSelection, getKnowledgeDomainBlessingsSkillSelections, getKnowledgeDomainBlessingsToolSelection,
                    ...
                    updateRangerDeftExplorerLanguageSelection, updateRangerFeyWandererGiftSelection, updateRangerGloomStalkerIronMindSavingThrowSelection, updateRangerHunterDefensiveTacticsChoice, updateRangerHunterPreyChoice, updateRangerLevel9ExpertiseSelection, updateRangerOtherworldlyGlamourSkillSelection, updateRogueExpertiseSelection,
                    updateRogueScionOfTheThreeDreadAllegianceChoice, updateRogueThievesCantLanguageSelection, updateSorcererDraconicElementalAffinityDamageTypeSelection, updateSorcererMetamagicSelection, updateWarlockFiendishResilienceDamageTypeSelection, updateWarlockMysticArcanumSelection, updateWeaponMasterySelection, updateWizardScholarSelection,
                    updateWizardSignatureSpellSelection, updateWizardSpellMasterySelection, warlockFiendPatronFiendishResilienceDamageTypeOptions, wizardScholarSkillOptions
                  })}
            </FeatureDisclosureRow>
          );
        })}
