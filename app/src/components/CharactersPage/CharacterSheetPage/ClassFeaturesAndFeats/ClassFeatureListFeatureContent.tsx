...
export function renderClassFeatureContent(context: Record<string, any>) {
  const {
    ...
    getAvailableRogueThievesCantLanguages, getAvailableSorcererMetamagicOptions, getAvailableWarlockMysticArcanumSpells, getAvailableWeaponMasteryOptions, getAvailableWizardScholarSkills, getAvailableWizardSignatureSpells, getAvailableWizardSpellMasterySpells, getBarbarianPrimalKnowledgeOptions, getBarbarianPrimalKnowledgeSelection, getBarbarianWildHeartAspectChoiceForCharacter,
    getBardExpertiseSelections, getBardLoreBonusProficiencySelections, getBardMagicalDiscoveriesSpellSelections, getBardPrimalLoreCantripSelection, getBardPrimalLoreSkillOptionsForCharacter, getBardPrimalLoreSkillSelection, getClericDivineOrderChoiceForCharacter, getDamageTypeChoiceContent, getDruidCircleOfTheLandChoiceForCharacter, getDruidPrimalOrderChoiceForCharacter,
    ...
    updateWeaponMasterySelection, updateWizardScholarSelection, updateWizardSignatureSpellSelection, updateWizardSpellMasterySelection, warlockFiendPatronFiendishResilienceDamageTypeOptions, wizardScholarSkillOptions
  } = context;
