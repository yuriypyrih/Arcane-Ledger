...
function getSorcererClockworkFeatureActions(
  ...
  if (hasSorcererClockworkBastionOfLawFeature(character)) {
    ...
    actions.push({
      ...
      breakdown: "Spend 1 to 5 Sorcery Points to create a ward of order",
      economyType: ECONOMY_TYPE.ACTION,
      actionCategory: ACTION_CATEGORY.MAGIC,
      interaction: "select",
  ...
  if (hasSorcererClockworkTranceOfOrderFeature(character)) {
    ...
    actions.push({
      ...
      breakdown: "Enter a state of perfect order for 10 turns",
  ...
  if (hasSorcererClockworkCavalcadeFeature(character)) {
    ...
    actions.push({
      ...
      breakdown: "Summon spirits of order in a 30-foot cube",
      economyType: ECONOMY_TYPE.ACTION,
      actionCategory: ACTION_CATEGORY.MAGIC,
      usesRemaining,
