...
export const poisonersKitItemKeys = new Set([
  "srd_poisoners-kit",
...
export const elementalAdeptEnergyMasteryDescription =
  "Spells you cast ignore Resistance to damage of the chosen type. In addition, when you roll damage for a spell you cast that deals damage of that type, you can treat any 1 on a damage die as a 2.";

export const feyTouchedFeyMagicDescription =
...
export const ritualCasterQuickRitualDescription =
...
export const shadowTouchedShadowMagicDescription =
